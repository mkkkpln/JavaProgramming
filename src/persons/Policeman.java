...
public class Policeman extends Person implements ForPoliceman, Speakable {
    ...
    public void stick() {
        ...
        System.out.println(this.name + " ткнул его кончиком дубинки в лоб. Раздался треск.");
    }

    @Override
    public void stick2() {

        System.out.print(" он с такой силой ткнул его в спину дубинкой, ");
    }

    @Override
    public void search() {
        System.out.print(Participle.POLICECATCHING.toString() + this.name + " принялся шарить у него в карманах и, ");
    }
    ...
    public void takeOff() {
        ...
        System.out.print("Это обстоятельство особенно " + Adverb.GOOD.toString() + " стало заметно, когда вошедший в комнату Фигль снял с головы каску");
    }
    ...
    @Override
    public void write() {
        System.out.println(Participle.BOX.toString() + this.name + " записал на нем Незнайкино имя, проставил рост, размер головы и носа, снял с него фотокарточку, просветил рентгеном, после чего испачкал ему обе руки черной краской и заставил оставить отпечатки пальцев на бланке.");
    ...
    @Override
    public void exist() {
        System.out.print("Если " + this.name + " был коротышка сердитый, не терпевший, как он сам утверждал, никаких разговоров, то ");
    }
    ...
    public void tell(String words) {
        System.out.println("Как только дверь затворилась за Фиглем, " + this.name + " сказал Незнайке: \"" + words + "\"");
    }
    ...
    public void give(String name) {
        System.out.println(this.name + ", которого, кстати сказать, звали Фиглем, сдал " + name + " с рук на руки другому полицейскому, которого звали Миглем.");
    }
